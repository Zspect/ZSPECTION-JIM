...
const InspectorDetails = ({ navigation }) => {
    ...
    const fetchBookingInfo = async () => {
        setBookLoading(true)
        API.fetchInspectorDetailsById(inspectorBookRes, navigation.state.params.data.bookingDetailId)
    }
                            ...
                            {bookInfo.bookingStatus == INSPECTOR_BOOKING_STATUS.PENDING ?
                                <View style={{
                                    ...
                                    <View style={{ flex: 1.8, flexDirection: 'row' }}>
                                        ...
                                        >
                                            <Text style={styles.action_txt}>Start</Text>
                                        </TouchableOpacity>
                                        ...
                                        >
                                            <Text style={[styles.action_txt, { color: colors.red }]}>Stop</Text>
                                        </TouchableOpacity>
                                        <View style={{ width: 0.8, height: 32, backgroundColor: colors.gray }} />
                                    </View>
                                </View>
