...
const menuData = [
  { image: 'user', route: 'Inspection', title: 'Inspection' },
  { image: 'search', route: 'History', title: 'History' },
  { image: 'heart', route: 'Favorites', title: 'Favorite' },
  // { image: require('../../assets/images/group_956.png'), route: 'RealEstateHomes', title: 'Home' },
  { image: require('../../assets/images/group_958.png'), route: 'ProfileRoute', title: 'Profile' },
  { image: require('../../assets/images/group_958.png'), route: 'VendorStack', title: 'Partner Directory' },
  { image: require('../../assets/images/group_962.png'), route: 'ChangePasswordAgentRoute', title: 'Change Password' },
  { image: require('../../assets/images/logout.png'), route: 'Logout', title: 'Logout' },
]

export class SideMenuAgent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modalVisible: false,
  ...
  render() {
    ...
    return (
      <SafeAreaView style={{ flex: 1, padding: 10 }}>
        ...
        <Text style={menuStyle.itemTextBottom}>Version : 6.0.0</Text>
        <Text style={menuStyle.itemTextBottom}>Date : 27/July/2022</Text>
